...
let getFormData = function () {
  return {
    approvalNotes: {
      id: "approverequisition-reason-input",
      label: "Any Approval Remarks:",
      tooltip: "If you want, you can provide more info along your approval of this asset",
      errors: [],
      value: "",
      isValid: null,
      validations: {
...
export default {
  ...
  methods: {
    ...
    onSaveEdits() {
        var vm = this;
        vm.update("approveRequisition", "formData", this.edits.id, function(thisVm, res){
