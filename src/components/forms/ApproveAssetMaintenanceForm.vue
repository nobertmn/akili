...
let getFormData = function () {
  return {
    approvalNotes: {
      ...
      tooltip: "If you want, you can provide more info along your approval of this asset maintenance request form",
      errors: [],
      value: "",
      isValid: null,
      validations: {
...
export default {
  ...
  methods: {
    ...
    onSaveEdits() {
        var vm = this;
        vm.update("approveAssetMaintenance", "formData", this.edits.id, function(thisVm, res){
