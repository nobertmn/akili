...
let getFormData = function () {
  return {
    rejectedNotes: {
      id: "rejectdisposal-reason-input",
      label: "Reason For Rejection",
      tooltip: "Please provide a detailed reason for rejecting this disposal",
      errors: [],
      value: "",
      isValid: null,
      validations: {
...
export default {
  ...
  methods: {
    ...
    onSaveEdits() {
        var vm = this;
        vm.update("rejectDisposal", "formData", this.edits.id, function(thisVm, res){
