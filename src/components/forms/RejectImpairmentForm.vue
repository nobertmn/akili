...
let getFormData = function () {
  return {
    rejectedNotes: {
      id: "rejectimpairment-reason-input",
      label: "Reason For Rejection",
      tooltip: "Please provide a detailed reason for rejecting this impairment submission",
      errors: [],
      value: "",
      isValid: null,
      validations: {
...
export default {
  ...
  methods: {
    ...
    onSaveEdits() {
        var vm = this;
        vm.update("rejectImpairment", "formData", this.edits.id, function(thisVm, res){
