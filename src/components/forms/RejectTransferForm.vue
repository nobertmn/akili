...
let getFormData = function () {
  return {
    rejectedNotes: {
      id: "rejecttrasnfer-reason-input",
      label: "Reason For Rejection",
      tooltip: "Please provide a detailed reason for rejecting this transfer",
      errors: [],
      value: "",
      isValid: null,
      validations: {
...
export default {
  ...
  methods: {
    ...
    onSaveEdits() {
        var vm = this;
        vm.update("rejectTransfer", "formData", this.edits.id, function(thisVm, res){
