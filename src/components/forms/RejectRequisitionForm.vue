...
let getFormData = function () {
  return {
    rejectedNotes: {
      id: "rejectrequisition-reason-input",
      label: "Reason For Rejection",
      tooltip: "Please provide a detailed reason for rejecting this requisition",
      errors: [],
      value: "",
      isValid: null,
      validations: {
...
export default {
  ...
  methods: {
    ...
    onSaveEdits() {
        var vm = this;
        vm.update("rejectRequisition", "formData", this.edits.id, function(thisVm, res){
