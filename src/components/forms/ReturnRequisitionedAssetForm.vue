...
let getFormData = function () {
  return {
    returnedDate: {
      id: "returnrequisition-returned-date-input",
      label: "Return Date",
    ...
    custodianId: {
      id: "returnrequisition-custodian-input",
      label: "Custodian",
    ...
    returnedNotes: {
      id: "returnrequisition-notes-input",
      label: "Notes:",
      tooltip:
    ...
    condition: {
      id: "returnrequisition-condition-input",
...
export default {
  ...
  methods: {
    ...
    loadDependencies() {
      var vm = this;
      vm.fetch("returnRequisitionDependencies", function (thisVm, res) {
        thisVm.custodians = res.custodians;
        //get the custodian
        let custodian = res.allocation.custodian;
        if (custodian != null) {
