...
let getFormData = function () {
  return {
    rejectedNotes: {
      id: "rejectmaintenance-reason-input",
      label: "Reason For Rejection",
      tooltip: "Please provide a detailed reason for rejecting this asset maintenace request",
      errors: [],
      value: "",
      isValid: null,
      validations: {
...
export default {
  ...
  methods: {
    ...
    onSaveEdits() {
        var vm = this;
        vm.update("rejectAssetMaintenance", "formData", this.edits.id, function(thisVm, res){
