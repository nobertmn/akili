<template>
  <SimpleModal
    id="view-insurance-details-modal"
...
import AssetInsuranceViewer from "@/components/viewers/AssetInsuranceViewer.vue";
...
export default {
  ...
  computed: {
    cmptModalTitle() {
      let title = "Asset Insurance Details";
      return title;
    },
    cmptCloseBtnText() {
      let text = "Close";
