  ...
  <div class="d-flex justify-content-center align-items-start h-100 pt-3">
    <div class="w-50">
      <div class="d-flex justify-content-between align-items-center mb-1">
        <h4 class="mb-1">Company Branches</h4>
        <Button label="Add Branch" :is-disabled="isLoading" @on-click="onClickAddBtn" />
      </div>
      <vue-good-table
        :columns="columns"
        :rows="rows"
    ...
    <SimpleModal
      :id="toBeEdited?'add-branch-modal':'add-branch-modal'"
      :title="toBeEdited?'Edit Branch':'Add a Company Branch'"
    ...
    <SimpleModal
      ...
      title="Delete Branch Comfirmation"
...
import AddBranchForm from '@/components/forms/AddBranchForm.vue';
...
export default {
  ...
  methods: {
    ...
    loadDependencies() {
      var vm = this;
      vm.fetch("settingsBranchesDependencies", function (thisVm, res) {
        vm.rows = res.branches;
      });
    },
    onClickAddBtn(){
    ...
    onClickDeleteModalOkBtn(){
      var vm = this;
      vm.delete("deleteBranch", vm.itemToDelete, function(vmres, res){
