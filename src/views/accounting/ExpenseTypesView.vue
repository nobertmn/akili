  ...
  <div class="d-flex justify-content-center align-items-start h-100 pt-3">
    <div class="w-75">
      <div class="d-flex justify-content-between align-items-center mb-1">
        ...
        <Button label="Add Expense Category" :is-disabled="isLoading" @on-click="onClickAddBtn" />
      </div>
      <vue-good-table
        :columns="columns"
        :rows="rows"
    ...
    <SimpleModal
      :id="toBeEdited?'add-expense-category-modal':'add-expense-category-modal'"
      :title="toBeEdited?'Edit Expense Category':'Add an Expense Category'"
    ...
    <SimpleModal
      id="delete-expense-category-modal"
      title="Delete Expense Category Comfirmation"
    ...
    >
      <DeleteConcentForm
        ...
        :seed="{ expense_category: [itemToDelete.id] }"
        :pst="pst"
...
import AddExpenseCategoryForm from '@/components/forms/AddExpenseCategoryForm.vue';
...
export default {
  ...
  methods: {
    ...
    loadDependencies() {
      var vm = this;
      vm.fetch("expenseCategoriesDependencies", function (thisVm, res) {
        vm.rows = res.expenseCategories;
      });
    },
    onClickAddBtn(){
