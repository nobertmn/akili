  ...
  <div class="d-flex justify-content-center align-items-start h-100 pt-1">
    <div class="w-90">
      <div class="d-flex justify-content-between align-items-center">
        <h4 class="mb-1">Assets Warranties</h4>
      </div>
      <vue-good-table
        :columns="columns"
        :rows="rows"
    ...
    <SimpleModal
      :id="toBeEdited ? 'edit-warranty-modal' : 'add-warranty-modal'"
      :title="toBeEdited ? 'Edit Assets Warranty Form' : 'New Asset Warranty Form'"
    ...
    <SimpleModal
      id="delete-warranty-modal"
      title="Delete Assets Warranty Comfirmation"
    ...
    >
      <DeleteConcentForm
        ...
        :seed="{ warranty: [itemToDelete.id] }"
        :pst="pst"
        :title="'This will remove warranty #' + itemToDelete.id"
...
import AddAssetWarrantyForm from "@/components/forms/AddAssetWarrantyForm.vue";
import DeleteConcentForm from "@/components/forms/DeleteConcentForm.vue";
import WarrantyDetailsModal from "@/components/modals/WarrantyDetailsModal.vue";
...
export default {
  ...
  methods: {
    ...
    loadDependencies(callBack) {
      ...
      vm.fetch("warrantyDependencies", function (thisVm, res) {
        thisVm.rows = res.warranties;
        callBack();
      });
    },
    onClickAddBtn() {
